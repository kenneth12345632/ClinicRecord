...
<div class="p-6 max-w-7xl mx-auto">
    ...
    <div class="mb-8 flex justify-between items-end">
        <div>
            ...
            <p class="text-gray-600 mt-1">Daily Summary & Center Management</p>
        </div>
                ...
                <div class="p-4 flex items-center justify-between hover:bg-slate-50/50 transition">
                    <div class="flex items-center gap-4">
                        <div class="w-10 h-10 rounded-full bg-slate-100 flex items-center justify-center font-bold text-slate-500">
                            {{ substr($recent->first_name, 0, 1) }}{{ substr($recent->last_name, 0, 1) }}
                        </div>
                        <div>
                            <p class="font-bold text-slate-800">{{ $recent->first_name }} {{ $recent->last_name }}</p>

...
<div class="max-w-5xl mx-auto py-6 px-4 pb-14">
    <div class="mb-6 flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
        ...
        @unless($isDoctorRole)
            <a href="{{ route('medicines.edit', $medicine) }}" class="shrink-0 inline-flex items-center justify-center gap-2 px-5 py-2.5 bg-green-50 text-green-600 rounded-xl text-sm font-bold hover:bg-green-100 transition shadow-sm">

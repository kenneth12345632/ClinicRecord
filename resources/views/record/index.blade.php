...
let recordsVisible = localStorage.getItem('toggle_bhw_patient_records') === 'true';
...
function applyFilters(showPatientRecords = true) {
    if (showPatientRecords) {
        recordsVisible = true;
        localStorage.setItem('toggle_bhw_patient_records', true);
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (toggleBtn) {
        toggleBtn.addEventListener('click', function () {
            ...
            localStorage.setItem('toggle_bhw_patient_records', recordsVisible);
            updateToggleButtonLabel();
            applyFilters(false);
        });
    }

        ...
        <div class="space-y-6">
            <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                ...
                <div class="grid grid-cols-1 gap-3">
                    <a href="{{ route('doctor.record.index') }}" class="flex items-center gap-3 p-3 rounded-xl border border-gray-50 hover:border-blue-100 hover:bg-blue-50/50 transition group">
                        ...
                        <span class="text-sm font-bold text-slate-600">Clinic Records</span>
                    </a>
                    <a href="{{ route('doctor.record.index') }}" class="flex items-center gap-3 p-3 rounded-xl border border-gray-50 hover:border-emerald-100 hover:bg-emerald-50/50 transition group">
                        ...
                        <span class="text-sm font-bold text-slate-600">Add Consultation</span>
                    </a>
                </div>
            </div>
        </div>
